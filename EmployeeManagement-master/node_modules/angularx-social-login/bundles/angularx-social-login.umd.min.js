(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FacebookLoginProvider = /** @class */ (function (_super) {
        __extends$2(FacebookLoginProvider, _super);
    ...
    var LinkedInLoginProvider = /** @class */ (function (_super) {
        __extends$3(LinkedInLoginProvider, _super);
        function LinkedInLoginProvider(clientId, authorize, lang) {
            var _this = _super.call(this) || this;
            _this.clientId = clientId;
        ...
        function () {
            ...
            return new Promise(function (resolve, reject) {
                _this.loadScript(LinkedInLoginProvider.PROVIDER_ID, '//platform.linkedin.com/in.js', function () {
                    var /** @type {?} */ that = _this;
                    setTimeout(function () {
                        that.signIn().then(function (user) { return resolve(user); });
                    }, 800);
                }, false, inner_text);
            });
        };
